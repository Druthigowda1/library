...
const Class1 = () => {
    ...
    const chapters = [
        ...
        },
        {
            ...
            books: [
                {
                    title:
                        "Quadratic Equation Memory – Based Questions Asked in IBPS RRB PO / Clerk",
                    file: "/pdfs/quant/all-questions.pdf",
                },
                {
                    title: "Number Series Practice Questions",
                    file: "/pdfs/quant/Number series.pdf",
                },
            ],
        },
        {
            ...
            books: [
                ...
                {
                    title: "Averages Practice Questions",
                    file: "/pdfs/averages-practice.pdf",
                },
            ],
        },
        {
    ...
    const [activeBtn, setActiveBtn] = useState("SBI");
    ...
    const handleSelect = (type) => {
        setActiveBtn(type);
        navigate(type === "SBI" ? "/sbi-books" : "/ibps-books");
    };

    /* ---------------- PDF SECTION ---------------- */
    const renderContent = () => {
        const chapter = chapters.find((c) => c.title === selectedChapter);

        return (
            <Box sx={{ p: { xs: 2, md: 4 } }}>
                <Typography variant="h4" sx={{ mb: 3, fontWeight: "bold" }}>
                    {chapter.title} – Syllabus & Practice Books
                </Typography>
                ...
                {chapter.books.map((book, idx) => (
                    ...
                    >
                        ...
                        <Box sx={{ display: "flex", gap: 1 }}>
                            ...
                            <Button onClick={() => setOpenShareIndex(idx)}>
                                <ShareIcon />
                            </Button>
                        </Box>
                    </Card>
        ...
        <>
            ...
            <Grid container sx={{ minHeight: "100vh" }}>
                ...
                <Grid item xs={12} md={9}>
                    <Box sx={{ p: 3, display: "flex", justifyContent: "center", gap: 2, mt: { xs: -7, md: 5 } }}>
                        <Button
                            variant={activeBtn === "SBI" ? "contained" : "outlined"}
                            onClick={() => handleSelect("SBI")}
                        >
                            SBI
                        </Button>
                        <Button
                            variant={activeBtn === "IBPS" ? "contained" : "outlined"}
                            onClick={() => handleSelect("IBPS")}
                        >
                            IBPS
                        </Button>
                    </Box>
