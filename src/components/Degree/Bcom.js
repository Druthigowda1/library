...
const Class1 = () => {
    ...
    const [activeBtn, setActiveBtn] = useState("BCOM");
   ...
   ------------------------------ */
    ...
    const getContent = () => {
        switch (selectedBoard) {
            case "1st Year":
                return renderPdfSection("All BCOM Books - 1st Year", cbseBooks, "1st-Year");
            case "2nd Year":
                return renderPdfSection("All BCOM Books - 2nd Year", icseBooks, "2nd-Year");
            default:
                return renderPdfSection("All BCOM Books - 3rd Year", kannadaBooks, "3rd-Year");
        }
    };
