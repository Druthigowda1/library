...
const Class1 = () => {
    ...
    const [activeBtn, setActiveBtn] = useState("BA");
   ...
   ------------------------------ */
    ...
    const getContent = () => {
        switch (selectedBoard) {
            case "1st Year":
                return renderPdfSection("All BA Books - 1st Year", cbseBooks, "1st-Year");
            case "2nd Year":
                return renderPdfSection("All BA Books - 2nd Year", icseBooks, "2nd-Year");
            default:
                return renderPdfSection("All BA Books - 3rd Year", kannadaBooks, "3rd-Year");
        }
    };
