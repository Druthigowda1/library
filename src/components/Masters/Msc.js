...
const Class1 = () => {
    ...
    const [activeBtn, setActiveBtn] = useState("MSC");
   ...
   ------------------------------ */
    ...
    const getContent = () => {
        switch (selectedBoard) {
            case "1st Year":
                return renderPdfSection("All MSC Books - 1st Year", cbseBooks, "1st-Year");
            // case "2nd Year":
            //     return renderPdfSection("All BA Books - 2nd Year", icseBooks, "2nd-Year");
            default:
                return renderPdfSection("All MSC Books - 2nd Year", kannadaBooks, "2nd-Year");
        }
    };
