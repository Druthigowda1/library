...
const Class1 = () => {
    ...
    const [activeBtn, setActiveBtn] = useState("MCOM");
   ...
   ------------------------------ */
    const handleSelect = (type) => {
        ...
        switch (type) {
            case "MCOM":
                navigate("/masters/mcom");
                break;
            case "MBA":
                navigate("/masters/mba");
                break;
            case "MCA":
                navigate("/masters/mca");
                break;
            case "MSC":
                navigate("/masters/msc");
                break;
            case "MA":
                navigate("/masters/ma");
                break;
        ...
        <Grid item xs={12} sx={{ p: { xs: 2, md: 3 } }}>
            ...
            {["firstPUC", "secondPUC"].map((year) => (
                <Box key={year} sx={{ mb: 4 }}>
                    ...
                    >
                        {year === "firstYear" ? "Study Material" : "Previous Year Papers"}
                    </Typography>
    ...
    const getContent = () => {
        switch (selectedBoard) {
            case "1st Year":
                return renderPdfSection("All MCOM Books - 1st Year", cbseBooks, "1st-Year");
            // case "2nd Year":
            //     return renderPdfSection("All BA Books - 2nd Year", icseBooks, "2nd-Year");
            default:
                return renderPdfSection("All MCOM Books - 2nd Year", kannadaBooks, "2nd-Year");
        }
    };
