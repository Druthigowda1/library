...
const Class1 = () => {
    ...
    const [activeBtn, setActiveBtn] = useState("Science");
   ...
   ------------------------------ */
    ...
    const getContent = () => {
        switch (selectedBoard) {
            case "1st Year":
                return renderPdfSection("All PUC Books - 1st Year", cbseBooks, "pcmb");
            case "2nd Year":
                return renderPdfSection("All PUC Books - 2nd Year", icseBooks, "pcmc");
            // case "HEBA":
            //     return renderPdfSection("All PUC Books - HEBA", icseBooks, "heba");
            default:
                return renderPdfSection("All PUC Books - PCME", kannadaBooks, "pcme");
        }
    };
