...
const Class1 = () => {
    ...
    const [selectedBoard, setSelectedBoard] = useState("CEBA");
    const [activeBtn, setActiveBtn] = useState("Commerce");
   ...
   ------------------------------ */
    ...
    const getContent = () => {
        switch (selectedBoard) {
            case "CEBA":
                return renderPdfSection("All PUC Books - CEBA", cbseBooks, "ceba");
            case "SEBA":
                return renderPdfSection("All PUC Books - SEBA", icseBooks, "seba");
            case "HEBA":
                return renderPdfSection("All PUC Books - HEBA", icseBooks, "heba");
            default:
                return renderPdfSection("All PUC Books - MEBA", kannadaBooks, "meba");
        }
    };
                    ...
                    {["CEBA", "SEBA", "HEBA", "MEBA",].map((board) => (
                        <Box
                            ...
                            sx={{
                                ...
                                fontSize: "18px",
                                fontWeight: 600,
                                bgcolor: selectedBoard === board ? "purple" : "#2f4670",
                                color: selectedBoard === board ? "white" : "white",
                                border: selectedBoard === board ? "2px solid white" : "1px solid black",
                            }}
