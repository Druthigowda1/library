...
const booksData = {
    firstPUC: [
        { title: "AI in Healthcare: Opportunities and Challenges", file: "/pdfs/research/AI-and-Robotics-IBA-GEI-April-2017.pdf" },
        { title: "Robotics in Manufacturing Industries", file: "/pdfs/research/AI-and-Robotics-IBA-GEI-April-2017.pdf" },
        { title: "Cloud Computing Security Issues and Solutions", file: "/pdfs/research/AI-and-Robotics-IBA-GEI-April-2017.pdf" },
        { title: "Big Data Analytics for Smart Cities", file: "/pdfs/research/AI-and-Robotics-IBA-GEI-April-2017.pdf" },
        { title: "Machine Learning for Predictive Maintenance", file: "/pdfs/research/AI-and-Robotics-IBA-GEI-April-2017.pdf" },
        { title: "IoT Enabled Smart Agriculture", file: "/pdfs/research/AI-and-Robotics-IBA-GEI-April-2017.pdf" },
        { title: "Cybersecurity Threats in Modern IT Systems", file: "/pdfs/research/AI-and-Robotics-IBA-GEI-April-2017.pdf" },
        { title: "Blockchain Applications in Finance", file: "/pdfs/research/AI-and-Robotics-IBA-GEI-April-2017.pdf" },
        { title: "Deep Learning for Image Recognition", file: "/pdfs/research/AI-and-Robotics-IBA-GEI-April-2017.pdf" },
        { title: "Cloud Analytics for Business Intelligence", file: "/pdfs/research/AI-and-Robotics-IBA-GEI-April-2017.pdf" },
    ],
    secondPUC: [
...
const headings = [
    ...
    { first: "Cyber Security IEEE PAPER", second: "Deep Learning IEEE PAPER" },
...
const Class1 = () => {
    ...
    const [activeBtn, setActiveBtn] = useState("Journal");
                ...
                {headings.map((heading, hIndex) => {
                    ...
                    return (
                        <Box key={hIndex} sx={{ mb: 4 }}>
                            <Typography variant="h5" sx={{ mb: 2, fontWeight: "bold", color: "#2f4670" }}>
                                {year === "firstPUC" ? heading.first : heading.second}
                            </Typography>
                            ...
                            <Grid container spacing={2}>
                                {pdfs.map((book, idx) => (
                                    <Grid item xs={12} md={6} key={idx}>
                                        ...
                                        >
                                            <Typography sx={{ fontWeight: 600, cursor: "pointer" }} onClick={() => openPDF(book.file)}>
                                                {book.title}
                                            </Typography>
    ...
    return (
        <>
            {/* HEADER */}
            <Box sx={{ position: "fixed", top: 0, width: "100%", zIndex: 1200, bgcolor: "#fff" }}>
                <Header />

                <Box sx={{ borderBottom: "2px solid black", py: 1 }}>
                    <Box sx={{ display: "flex", justifyContent: "center", p: 2 }}>
                        {isSmDown && <IconButton onClick={scrollLeft}><ChevronLeftIcon /></IconButton>}

                        <Box ref={scrollRef} sx={{ display: "flex", gap: 2, overflowX: "auto", "&::-webkit-scrollbar": { display: "none" } }}>
                            {["Research", "Journal"].map((label) => (
                                <Button key={label} variant={activeBtn === label ? "contained" : "outlined"} onClick={() => handleSelect(label)} sx={{ minWidth: 160 }}>
                                    {label}
                                </Button>
                            ))}
                        </Box>

                        {isSmDown && <IconButton onClick={scrollRight}><ChevronRightIcon /></IconButton>}
                    </Box>
                </Box>
            </Box>
            ...
            <Grid container sx={{ mt: `${FIXED_HEADER_HEIGHT}px` }}>
                ...
                <Grid item xs={12} md={10}>
                    <Box sx={{ p: { xs: 2, md: 4 }, mt: 3 }}>
                        {/* MOBILE STREAM MENU BUTTON */}
                        <Box sx={{ display: { xs: "flex", md: "none" }, mb: 2 }}>
                            <Button startIcon={<MenuIcon />} variant="outlined" onClick={() => setMobileStreamOpen(true)}>
                                Streams
                            </Button>
                        </Box>
